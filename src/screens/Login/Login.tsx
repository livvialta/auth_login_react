...
const Login = () => {
    ...
    //referencia para o obj de autenticação
    ...
    return(
      <View style={styles.container}>
        ...
        />
      {loading ? (<ActivityIndicator/>) : (<View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.buttonClick} onPress={handleLogin}>
        <Text style={styles.buttonText}>Login</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.buttonClick} onPress={handleNewAccont}>
